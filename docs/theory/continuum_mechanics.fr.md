...
tenseur gradient de la transformation, appelé le jacobien $J$.
...
surface $ds$ de normale $\mathbf{n}$ en utilisant la formule de Nanson:
...
$C_t$ par \mathbf{D}, ces deux tenseurs étant *transportés* l'un de l'autre
par la relation :
